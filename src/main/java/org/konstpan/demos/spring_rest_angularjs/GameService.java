...
public class GameService {
  ...
  public GameService() {
    ...
    game = new Game();
    game.setId(6);
    game.setName("Combat Mission - Battle for Normandy");
    game.setSnippet("Combat Mission - Battle for Normandy (CM:BN) faithfully recreates the experience of tactical land warfare in Western France during World War Two.");
    games.add(game);
  }
